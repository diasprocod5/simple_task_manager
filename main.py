...
from scr.tasks import  tasks_tiny_db
...
# title, descr, _tags, done, task_id
@dataclass
class Task:
    ...
    def __repr__(self):
        return f'Task(title={self.title!r}, descr={self.descr!r}, tags={self.tags}, done={self.done}, task_id={self.task_id})'
